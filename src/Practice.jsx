      ...
      <div className="row">
        <div className="col-md-10">
          ...
          <p className="me-2 mt-3">
            <b className="me-2">Learning Outcomes</b> At the end of this course,
            participants should be able to:
          </p>
          <ul>
            <li className="list-group-item">
              1. Understand what is soil health
            </li>
            <li className="list-group-item">
              2. Identify soils which are healthy and soils which are not
              healthy
            </li>
            <li className="list-group-item">
              3. Know the benefits of having healthy soils
            </li>
            <li className="list-group-item">
              4. Identify various ways to improve soil health
            </li>
            <li className="list-group-item">
              5. Create an action plan for improving soil health and
              productivity
            </li>
          </ul>

          <div className="d-flex align-items-center mb-2">
            <b className="me-2">Pre-Requisites:</b>
            <p className="mb-0">
          ...
          <div>
            <ul>
              <li>1. No pre-requisite is needed</li>
            </ul>
          </div>
          ...
          <div className="col-md-12">
            ...
            <ul>
              <li className="list-group-item">
                1. A field with good soil health nearby a field with poor soil
                health
              </li>
              <li className="list-group-item">2. 1 hoe or shovel</li>
              <li className="list-group-item">
                3. 2 containers to collect soil
              </li>
              <li className="list-group-item">4. Soil health poster</li>
              <li className="list-group-item">5. Flip chart and marker pens</li>
              <li className="list-group-item">
                6. Seeds (at least 10 per participant)
              </li>
            </ul>
          </div>
          ...
          <div className="col-md-12">
            ...
            <ul>
              <li className="list-group-item">
                1. Sample the 2 soils ahead of time to assure that there are
                visible differences between them.
              </li>
              <li className="list-group-item">
                2. Use the Decision Support Tool App to identify several
                high-potential sustainable intensification technologies suitable
                for this specific area.
              </li>
              <li className="list-group-item">
                3. Review all discussion questions and be prepared to guide the
          ...
          <div className="row">
            <div className="col-md-8">
              ...
              <ul>
                <li>
                  1. Ask the group to explain how they know when a soil is
                  healthy or fertile. What are the signs that they look for?
                ...
                <li>
                  2. Present the soil health poster and ask them which of the
                  maize leaves looks like it was growing in a healthy soil
                </li>
                <li>
                  3. Ask if they have a word in their local language that is
                  used to describe a healthy soil?
                </li>
                <li>
                  4. Why is it important for our soils to be healthy? Allow them
                  to give their answers first, but be sure that they discuss
                  higher productivity, lower input costs, easier soil
          ...
          <div className="col-md-10">
            ...
            <b>1. Dig 4-5 liters of topsoil and place them in the bucket</b>
            <p>
              <b>
            ...
            <p>
              ...
              poster).
              <br />
              b) The soil from the regenerative field is softer and more crumbly
              <br />
              c) The soil from the regenerative field has more roots growing in
              it
            </p>
            <b>2. Which field has healthier-looking crops?</b>
            <i>
              If the field has already been harvested ask them if they remember
              which field was more productive during the previous season.
            </i>
            <br />
            <b>3. Which field would you rather farm in the next season? Why?</b>
          </div>
          ...
          <div className="col-md-10">
            ...
            <p>
              2. Supplement their list by writing down and explaining any other
            ...
            <p>
              4. Use the 10-seed method (see Appendix A) to identify the top 2-3
              methods which they will try in the coming season.
            </p>
            <p>
            ...
            <p>
              7. Thank them for their wisdom and insights throughout the lesson!
            </p>
          </div>
    ...
    <div className="container mt-4">
      <div className="row">
        <div className="col-md-10">
          ...
          <div className="row">
            <img />
            <p>Centre for Sustainable Development. </p>
          </div>
          <p>
          ...
          <h1>Learning Activities (Total time required = 2-3 hours)</h1>
          <h1>
            Introduction (The Mother Earth drama, in Appendix A, can be used
            here as an attention grabber, or later as an energizer)
          </h1>
          <h2>
            Opening Discussion – write their responses on the flip chart (15
            minutes)
          </h2>
          <h3>
          ...
          <h1>Practical Training (60 minutes)</h1>
          <h2>
            Take the group to a field where regenerative agriculture has been
            practiced (e.g. Conservation Agriculture, double-up legumes, cover
            crops, etc.)
          </h2>

          <h3>
            <strong>
              Dig 4-5 liters of topsoil and place them in the bucket
            </strong>
          </h3>

          <h2>
            Take the group to a field where extractive agriculture has been
            practiced (e.g. continuous maize, crop residue burning, etc.)
          </h2>
          <h3>
            <strong>
              Dig 4-5 liters of topsoil and place them in the bucket
          ...
          <h2>
            Allow each farmer to take a handful of each soil and examine them
            for several minutes (if the sun is hot, take the buckets to a shady
            spot before destributing samples and holding the following
            discussion:
          </h2>
          <h3>
            <strong>
              What differences have you seen between these two soils?
            </strong>{" "}
            <strong>
              <em>
                Allow them to give their answers first, but be sure that they
          ...
          <h3>
            <strong>Which field has healthier-looking crops? </strong>
            <em>
              If the field has already been harvested ask them if they remember
          ...
          <h3>
            <strong>
              Which field would you rather farm in the next season? Why?
            </strong>{" "}
          </h3>
          <h1>
            Follow-up Discussion (45 minutes) Return to a comfortable meeting
          ...
          <h3>
            What is the “food” which makes soils healthy?{" "}
            <em>
              Allow them to give their responses, but if they struggle, help
              them see that it is the organic inputs like crop residues, manure,
              cover crops, etc. which truly “feed” soils.
            </em>
          </h3>
          ...
          <h3>
            ...
            high-potential methods which you have identified for this community
          </h3>
          <h3>
          ...
          <h3>
            Use the 10-seed method (
            <strong>
              <em>see Appendix A</em>
            </strong>
            ) to identify the top 2-3 methods which they will try in the coming
            season.
          </h3>
          ...
          <h3>Ask them if they have any unanswered questions.</h3>
          ...
          <h3>A mother struggles to feed her 2 greedy children. </h3>

          <h4>
            She goes to the garden each day, works hard and brings food home to
            cook for them
          </h4>
          ...
          <h4>After some time she dies of hunger..</h4>
