...
import MainDashBoard from "../HFS/Home/MainDashBoard";
import Notification from "../HFS/Notification/Notification";
import Report from "../HFS/Report/Report";
import User from "../HFS/Users/User";
import Setting from "../HFS/Setting/Setting";

const authProtectedRoutes = [
  //NEW- ROUTES FOR HYDRO-POWER PLANTE FORECASTING SYSTEM:-
  { path: "/dashboard-main", component: <MainDashBoard /> },
  ...
  // eslint-disable-next-line react/display-name
  {
    path: "/",
    exact: true,
    component: <Navigate to="/dashboard-main" />,
  },
  { path: "*", component: <Navigate to="/dashboard-main" /> },
];
